...
////////////////LEFT SHOULDER//////////////////  
  ...
  if (lShoulderID == `none`) {
    ...
    case `MS`:
      ...
      AP cost: ${weaponShoulder[lShoulderID].apCost}
...
///////////////RIGHT SHOULDER//////////////////
  ...
  if (rShoulderID == `none`) {
    ...
    case `MS`:
      ...
      AP cost: ${weaponShoulder[rShoulderID].apCost}
...
document.querySelector(`#setupBox`).addEventListener(`mouseup`, updateDisplay);
